        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-end">
              ...
              <form action="{{route('medicines2.import')}}" method="POST" enctype="multipart/form-data" class="ml-2 pr-5">
                @csrf
              ...
              <div >
                <a class="btn btn-success" href="{{ route('medicines2.create') }}">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody id="medicineTable">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('medicines2.edit', $medicine->id) }}" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <form action="{{ route('medicines2.destroy', $medicine->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
