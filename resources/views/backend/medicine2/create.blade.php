      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            ...
            @endif
            <div class="card-body">
              <form action="{{ route('medicines2.store') }}" method="POST">
                @csrf

                <div class="form-group">
                  <label for="name">Medicine Name</label>
                  <input type="text" class="form-control" id="name" name="medicine_name" value="{{ old('medicine_name') }}" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="price" name="amount" value="{{ old('amount') }}" required>
                </div>
