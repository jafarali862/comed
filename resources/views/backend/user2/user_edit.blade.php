      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('users2.index') }}">Users</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('users2.update', $user->id) }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="user_type" onChange="UserType()" name="user_type" required>
                    ...
                    <option value="1" {{ old('gender', $user->user_type) == 1 ? 'selected' : '' }}>Field Agent</option>
                    <option value="0" {{ old('gender', $user->user_type) == 0 ? 'selected' : '' }}>User</option>
                  </select>
                </div>
                  ...
                  <label for="type">Type</label>
                    ...
                    <option value="1" {{ old('type', $user->type) == '1' ? 'selected' : '' }}>Clinics</option>
                    <option value="2" {{ old('type', $user->type) == '2' ? 'selected' : '' }}>Pharmacy</option>
                    <option value="3" {{ old('type', $user->type) == '3' ? 'selected' : '' }}>Both</option>
                    <option value="4" {{ old('type', $user->type) == '4' ? 'selected' : '' }}>None</option>
                    </select>
                </div>
              ...
              <div id="hider" style="display:none;">
                ...
                <a href="{{ route('users2.index') }}" class="btn btn-secondary">Cancel</a>
