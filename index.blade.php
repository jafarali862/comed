        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="col-md-12 d-flex justify-content-end mt-2 mb-4">
              <a href="{{ route('daybook.export', request()->query()) }}" class="btn btn-success pt-2 pb-2">
                Export Excel
              </a>
            </div>
            ...
            <form method="GET" class="mb-4">
              <div class="row align-items-end" style="margin:20px 10px;">
                ...
                <div class="col-md-3">
                  ...
                  <select name="pharmacy_id" id="pharmacy_id" class="form-control select2">
            ...
            <table class="table" id="example1">
              ...
              <tbody>
                ...
                @foreach($payments as $payment)
                  @php $totalAmount += $payment->total_amount; @endphp
                  <tr>
              ...
              <tfoot>
                <tr>
                  <td colspan="3" class="text-end"><strong>Total Amount Collected:</strong></td>
